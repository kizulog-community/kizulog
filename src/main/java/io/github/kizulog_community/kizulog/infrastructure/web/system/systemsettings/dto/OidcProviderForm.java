...
public class OidcProviderForm {
    ...
    @Pattern(regexp = "^[a-z0-9-]+$",
            message = "{system.oidcProviders.form.error.providerId.format}")
    @Size(min = 1, max = 32,
            message = "{system.oidcProviders.form.error.providerId.size}")
    ...
    @Size(max = 500,
            message = "{system.oidcProviders.form.error.uri.size}")
    private String uri;
