...
/**
 * 業務テナントアカウント認証方法ステータスEntity
 *
 * @author Jun Kobayashi
 */
@Entity
@Table(name = "tenant_account_identity_status")
@Getter
@NoArgsConstructor
@AllArgsConstructor
public class TenantAccountIdentityStatusEntity {

    @EmbeddedId
    private TenantAccountIdentityStatusId id;
