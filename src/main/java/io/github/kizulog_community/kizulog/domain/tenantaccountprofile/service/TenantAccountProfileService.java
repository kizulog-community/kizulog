...
public class TenantAccountProfileService {

    /** ロガー */
    private static final Logger log =
            LoggerFactory.getLogger(TenantAccountProfileService.class);

    /** プロファイルリポジトリ */
    private final TenantAccountProfileRepository repository;
    ...
    public Optional<TenantAccountProfile> getProfile(String identityId) {
    ...
    public void upsertIfChanged(
        ...
        Optional<TenantAccountProfile> latest =
        ...
        TenantAccountProfile profile = new TenantAccountProfile(
                identityId,
                version,
                newClaims,
                version,
